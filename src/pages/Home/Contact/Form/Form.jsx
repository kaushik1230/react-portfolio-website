    ...
    <div className={[className, styles.form, classes.form].join(" ")}>
      ...
      >
        ...
        <TextField
          ...
          onChange={(e) =>
            setFormStates((prev) => ({ ...prev, email: e.target.value }))
          }
        />
      </Box>
      <Box
      ...
      >
        ...
        <TextField
          ...
          onChange={(e) =>
            setFormStates((prev) => ({ ...prev, message: e.target.value }))
          }
        />
      </Box>
      ...
      {formStates.loading ? (
        <div className={styles.waitingMsg}>
          It may take up to <span>5 seconds</span> to send !
        </div>
      ) : (
        ""
      )}
...
If you would like to contact me, please send an email to Kaushik199906@gmail.com
${error}`;
...
const SendButton = ({ loading, submitForm }) => (
  <ClippedButton
    onClick={submitForm}
    color="skyblue"
    className={[styles.clippedButton, loading ? styles.disabled : ""].join(" ")}
  >
...
const LoadingContent = () => (
  <>
    <svg
      className={[styles.loading, styles.svgInline].join(" ")}
      aria-hidden="true"
      focusable="false"
      data-prefix="fas"
      data-icon="spinner"
